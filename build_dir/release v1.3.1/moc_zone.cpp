...
#include <memory>
#include "../../ZalfonIntegral/widgets/zone.h"
...
QT_MOC_LITERAL(1, 5, 15), // "editZoneEmitted"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "Zone*"
QT_MOC_LITERAL(4, 28, 4), // "zone"
QT_MOC_LITERAL(5, 33, 8), // "setAlarm"
QT_MOC_LITERAL(6, 42, 6), // "_state"
QT_MOC_LITERAL(7, 49, 14), // "setSilentAlarm"
QT_MOC_LITERAL(8, 64, 6) // "setArm"

    },
    "Zone\0editZoneEmitted\0\0Zone*\0zone\0"
    "setAlarm\0_state\0setSilentAlarm\0setArm"
};
...
void Zone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->editZoneEmitted((*reinterpret_cast< Zone*(*)>(_a[1]))); break;
        case 1: { bool _r = _t->setAlarm((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { bool _r = _t->setSilentAlarm((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: { bool _r = _t->setArm((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Zone::editZoneEmitted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Zone::editZoneEmitted(Zone * _t1)
{
